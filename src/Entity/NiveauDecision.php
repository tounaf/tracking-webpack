...
/**
 * @ORM\Entity(repositoryClass="App\Repository\NiveauDecisionRepository")
 */
class NiveauDecision
{
    /**
     * @ORM\Id()
     * @ORM\GeneratedValue()
    ...
    /**
     * @ORM\OneToMany(targetEntity="App\Entity\Cloture", mappedBy="niveauDecision")
     */
    private $clotures;
    ...
    public function addCloture(Cloture $cloture): self
    {
        if (!$this->clotures->contains($cloture)) {
            ...
            $cloture->setNiveauDecision($this);
        }
    ...
    public function removeCloture(Cloture $cloture): self
    {
        if ($this->clotures->contains($cloture)) {
            ...
            if ($cloture->getNiveauDecision() === $this) {
                $cloture->setNiveauDecision(null);
            }
        }
