...
$(document).ready(function () {
    ...
    function editRow(data, type, row) {
        data = '                             <button  data-target="#modalPassword" data-title="{{ \'label.edit.create\'|trans }}" data-route="edit_societe" class="btn btn-link text-danger btn-edit" data-id="{{ row.id }}" type="button"><i class="fa fa-edit"></i></button>\n' +
